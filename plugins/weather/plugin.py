...
MESSAGES = {
    "de": {
        ...
        "weather_for": "Wetter für {location}: {temperature}°C, {condition}, gefühlt {feels_like}°C, Luftfeuchtigkeit {humidity}%, Wind {wind_speed} km/h",
    ...
    "en": {
        ...
        "weather_for": "Weather for {location}: {temperature}°C, {condition}, feels like {feels_like}°C, humidity {humidity}%, wind {wind_speed} km/h",
